...
export const extraZh: DictionaryTree = {
  ...
  v3: {
    ...
    membership: {
      ...
      contactSteps:
        "添加微信或 Discord 联系阿吉，选择月付或年付后完成支付并获取激活码。支持微信、支付宝与 Wise 转账。",
      adminTitle: "激活码管理",
      adminGenerate: "批量生成",
      adminTier: "时长档位",
      adminCount: "数量",
  ...
  blog: {
    ...
    article: {
      ...
      backToList: "返回文章列表",
      htmlLoading: "加载图表内容…",
      translationFallback: "英文版本尚未提供，当前显示中文原文。",
      pdfAttachment: "PDF 附件",
      downloadAttachment: "下载附件",
      toc: "目录",
      tocNav: "文章导航",
      membersOnlyBadge: "会员专享",
      memberPaywall: {
        title: "开通会员阅读全文",
        body: "本文为会员专享内容，非会员可阅读前 50% 预览。开通会员即可解锁完整分析与附件。",
        cta: "查看会员方案",
      },
      share: {
        label: "分享",
        ...
        discord: "分享到 Discord",
        discordHint: "链接已复制，请粘贴到 Discord 分享",
        nativeShare: "系统分享",
        qrTitle: "微信扫码分享",
    ...
    documents: {
      ...
      ctaButton: "了解会员方案",
      lockedBadge: "需升级",
      lockedHint: "7 天体验会员仅可访问 50% 资料，升级月/年会员解锁全部内容。",
      trialCtaTitle: "升级月/年会员，解锁全部资料",
      trialCtaBodyWithCounts: "体验会员当前可见 {visible} 篇（50%），升级后可解锁全部 {total} 篇历史资料。",
      trialCtaButton: "查看月/年会员方案",
      accessBanner: {
        ...
        trialHeadline: "体验会员已解锁 {visible} / {total} 篇（50%）",
        trialSubline: "升级月/年会员可解锁全部历史资料与视频课程",
        trialCta: "升级月/年会员",
    ...
    courses: {
      title: "期权视频课程",
      subtitle: "系统学习期权策略、波动率与 GEX 实战。会员专享完整录播，访客可免费试看每支课程前 3 分钟。",
      empty: "暂无视频课程",
      emptyHint: "课程视频导入后将在此展示",
      totalCount: "共 {count} 支课程",
      sortNewest: "最新",
      sortOldest: "最早",
      sortPopular: "最热门",
      sortPopularSoon: "播放量统计即将上线",
      thumbnailPending: "封面待添加",
      watchTitle: "观看课程",
      watchSubtitle: "完整录播与访客试看",
      backToList: "返回课程列表",
      play: "播放",
      playLocked: "会员专享，需开通后播放",
      playCourse: "播放课程",
      memberOnly: "会员",
      lockedUpgrade: "升级解锁",
      previewAvailable: "试看可用",
      categoryLabel: "分类",
      accessBanner: {
        guestHeadline: "当前可见 {visible} 支 · 开通会员解锁全部 {total} 支",
        guestSubline: "访客试看每支前 3 分钟；升级后可无限回放",
        guestCta: "开通会员",
        memberHeadline: "已解锁全部 {total} 支课程",
        memberSubline: "完整录播无限回放",
        trialHeadline: "体验会员已解锁 {visible} / {total} 支（50%）",
        trialSubline: "升级月/年会员可观看全部课程",
        trialCta: "升级月/年会员",
        progressLabel: "已解锁 {visible} / {total}",
        categoryLine: "{visible}/{total}",
        categoryMore: "另有 {locked} 支会员专享",
      },
      player: {
        selectCourse: "选择下方课程开始播放",
        playingMember: "正在播放",
        playingGuest: "正在播放 · 访客试看模式",
        loadingVideo: "正在加载视频...",
        previewEndedBadge: "试看已结束",
        previewEndedTitle: "开通会员，继续观看完整课程",
        lockedTitle: "该课程需升级月/年会员后观看",
        lockedBody: "7 天体验会员仅可观看 50% 课程，升级后可无限回放全部录播。",
        lockedCta: "查看月/年会员方案",
        previewEndedBody: "您已看完本支课程 3 分钟试看片段。会员可解锁全部录播与配套 PDF 讲义。",
        previewCta: "立即开通会员",
        locked: "该课程仅会员可播放",
      },
    },
...
This page keeps the bio and public social links focused. Product positioning, data capabilities, and member benefits live on the homepage and pricing page.`,
    ...
    admin: {
      ...
      excerptZh: "摘要（中文）",
      bodyZh: "正文（中文）",
      englishSection: "英文版本（可选）",
      titleEn: "标题（English）",
      excerptEn: "摘要（English）",
      bodyEn: "正文（English）",
      bodyMarkdown: "正文 Markdown（中文）",
      bodyHtml: "正文 HTML（中文）",
      bodyMarkdownEn: "Body Markdown (English)",
      bodyHtmlEn: "Body HTML (English)",
      htmlUploadEn: "上传英文 .html 文件",
      hasEnglish: "含英文",
      contentFormat: "正文格式",
      ...
      courses: {
        nav: "视频课程管理",
        title: "视频课程管理",
        subtitle: "上传新课程或管理已导入课程的封面",
        coverHint: "推荐尺寸：1280×720 或 1920×1080（16:9），JPEG/PNG/WebP，最大 2MB",
        uploadNew: "上传新课程",
        uploadHint: "上传 MP4 视频后会出现在会员视频课程库；可同时上传封面图（推荐）",
        dropHint: "点击或拖拽 MP4 视频到此处",
        dropSubhint: "仅支持 MP4 格式，最大 2GB",
        coverDropHint: "点击或拖拽封面图到此处（可选）",
        coverOptional: "可选，推荐 1280×720",
        titleZh: "课程标题",
        titleRequired: "请填写课程标题",
        uploadVideo: "上传视频",
        uploading: "上传中…",
        mp4Only: "仅支持 MP4 视频文件",
        list: "课程列表",
        empty: "暂无视频课程",
        uploadCover: "上传封面",
        hasCover: "已设置封面",
        ...
        confirmDelete: "确定删除此视频课程？此操作不可恢复。",
        delete: "删除",
      },
      codes: {
        nav: "激活码管理",
        listTitle: "激活码列表",
        listSubtitle: "查看所有已生成的激活码及兑换状态",
        loadFailed: "加载激活码列表失败",
        empty: "暂无激活码",
        colPrefix: "码前缀",
        colTier: "时长",
        colStatus: "状态",
      ...
      users: {
        nav: "用户管理",
        title: "用户管理",
        subtitle: "查看注册用户、会员状态与激活码信息（仅管理员）",
        searchPlaceholder: "搜索邮箱…",
        filterAll: "全部",
        filterRole: "角色",
        filterMembership: "会员状态",
        roleUser: "用户",
        roleAdmin: "管理员",
        roleDisabled: "已禁用",
        memberActive: "会员",
...
export const extraEn: DictionaryTree = {
  ...
  membershipOffer: {
    ...
    tiers: {
      free: {
        ...
        cta: "Try data boards",
        f1: "Preview top 10 rows on data boards",
        f2: "SPY GEX glance (any symbol requires membership)",
        f3: "~30% document library sample",
        f4: "Read public posts",
      },
      member: {
        eyebrow: "Member",
        ...
        f3: "Member posts, PDFs, and full document library access",
  ...
  v3: {
    ...
    membership: {
      ...
      contactDiscord: "Discord",
      contactSteps:
        "Contact Aji on WeChat or Discord, choose monthly or annual, then pay to receive your activation code. WeChat Pay, Alipay, and Wise accepted.",
  ...
  blog: {
    ...
    article: {
      ...
      backToList: "Back to posts",
      htmlLoading: "Loading charts…",
      translationFallback: "English translation is not available yet. Showing the Chinese original.",
      ...
      memberPaywall: {
        title: "Upgrade to read the full article",
        body: "This article is for members. Guests can preview the first 50%. Upgrade to unlock the full analysis and attachments.",
      ...
      share: {
        ...
        discordHint: "Link copied — paste into Discord to share",
        nativeShare: "Share",
    ...
    documents: {
      ...
      lockedBadge: "Upgrade",
      lockedHint: "7-day trial members can access 50% of content. Upgrade to monthly or annual for full access.",
      trialCtaTitle: "Upgrade to monthly or annual membership",
      trialCtaBodyWithCounts: "Your trial unlocks {visible} of {total} documents (50%). Upgrade for the full archive.",
      trialCtaButton: "View monthly / annual plans",
      accessBanner: {
        ...
        trialHeadline: "Trial access: {visible} / {total} documents (50%)",
        trialSubline: "Upgrade to monthly or annual membership for the full library",
        trialCta: "Upgrade membership",
        progressLabel: "{visible} / {total} visible",
        categoryLine: "{visible}/{total}",
        categoryMore: "+{locked} member-only",
      },
      categories: {
        "daily-report": "Dark-flow daily",
    ...
    courses: {
      title: "Options video courses",
      subtitle: "Structured lessons on strategies, volatility, and GEX. Members get full replays; guests can preview the first 3 minutes of each visible course.",
      empty: "No video courses yet",
      emptyHint: "Imported course videos will appear here",
      totalCount: "{count} courses total",
      sortNewest: "Newest",
      sortOldest: "Oldest",
      sortPopular: "Popular",
      sortPopularSoon: "View counts coming soon",
      thumbnailPending: "Cover pending",
      watchTitle: "Watch course",
      watchSubtitle: "Full replay or guest preview",
      backToList: "Back to courses",
      play: "Play",
      playLocked: "Members only — upgrade to play",
      playCourse: "Play course",
      memberOnly: "Member",
      lockedUpgrade: "Upgrade to unlock",
      previewAvailable: "Preview available",
      categoryLabel: "Category",
      accessBanner: {
        guestHeadline: "{visible} visible now · Unlock all {total} with membership",
        guestSubline: "Guests get a 3-minute preview per course; members get unlimited replay",
        guestCta: "View membership",
        memberHeadline: "Full library unlocked — {total} courses",
        memberSubline: "Unlimited replay of every course video",
        trialHeadline: "Trial access: {visible} / {total} courses (50%)",
        trialSubline: "Upgrade to monthly or annual membership for every course",
        trialCta: "Upgrade membership",
        progressLabel: "{visible} / {total} unlocked",
        categoryLine: "{visible}/{total}",
        categoryMore: "+{locked} member-only",
      },
      player: {
        selectCourse: "Pick a course below to start playback",
        playingMember: "Now playing",
        playingGuest: "Now playing · guest preview",
        loadingVideo: "Loading video...",
        previewEndedBadge: "Preview ended",
        previewEndedTitle: "Upgrade to watch the full course",
        lockedTitle: "Monthly or annual membership required",
        lockedBody: "7-day trial members can watch 50% of courses. Upgrade for unlimited replay of the full library.",
        lockedCta: "View monthly / annual plans",
        previewEndedBody: "You have reached the 3-minute guest preview limit. Members unlock every course plus PDF handouts.",
        previewCta: "View membership",
        locked: "This course is available to members only",
      },
    },
    membership: {
      ...
      basic: {
        ...
        f2: "Member posts, PDFs, and full document library access",
        f3: "Ongoing market analysis and options opportunity reads",
        f4: "Activation-code access with stackable duration",
      },
      premium: {
        badge: "Recommended",
...
This page keeps the bio and public social links focused. Product positioning, data capabilities, and member benefits live on the homepage and pricing page.`,
    ...
    admin: {
      ...
      bodyZh: "Body (ZH)",
      englishSection: "English version (optional)",
      ...
      bodyMarkdownEn: "Body Markdown (English)",
      bodyHtmlEn: "Body HTML (English)",
      htmlUploadEn: "Upload English .html file",
      hasEnglish: "EN",
      ...
      courses: {
        nav: "Video courses admin",
        title: "Video courses admin",
        subtitle: "Upload new courses or manage cover images for existing videos",
        coverHint: "Recommended: 1280×720 or 1920×1080 (16:9), JPEG/PNG/WebP, max 2MB",
        uploadNew: "Upload new course",
        uploadHint: "Uploaded MP4 videos appear in the member library; add an optional cover in the same step",
        dropHint: "Click or drag an MP4 video here",
        dropSubhint: "MP4 only, max 2GB",
        coverDropHint: "Click or drag a cover image here (optional)",
        coverOptional: "Optional, 1280×720 recommended",
        titleZh: "Course title",
        titleRequired: "Course title is required",
        uploadVideo: "Upload video",
        uploading: "Uploading…",
        mp4Only: "MP4 video files only",
        list: "Course list",
        empty: "No video courses yet",
        ...
        confirmDelete: "Delete this video course? This cannot be undone.",
        delete: "Delete",
      },
      codes: {
        nav: "Activation codes",
        listTitle: "Activation codes",
        listSubtitle: "View all generated codes and redemption status",
        loadFailed: "Failed to load codes",
        empty: "No activation codes yet",
        colPrefix: "Prefix",
        colTier: "Tier",
        colStatus: "Status",
        colRedeemedBy: "Redeemed by",
      ...
      users: {
        ...
        subtitle: "View registered users, membership status, and activation code info (admin only)",
